...
| release archives, native source upgrade fallback, package-manager ownership, and Homebrew tap publication | [Compatibility](compatibility.md) | `internal/cli/upgrade.go`, `internal/selfupdate`, `.github/workflows/release.yml`, `daviddwlee84/homebrew-tap` sync workflow | implemented |
