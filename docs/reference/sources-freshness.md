...
| `dev pr` inbox, provider surfaces and the local worktree join | [Pull request inbox](../guides/pull-request-inbox.md) | `internal/forge/pr.go`, `internal/cli/pr*.go`, focused forge/CLI tests | implemented |
