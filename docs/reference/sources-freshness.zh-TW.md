...
| release archives、原生 source upgrade fallback、package-manager ownership 與 Homebrew tap publication | [相容性](compatibility.zh-TW.md) | `internal/cli/upgrade.go`、`internal/selfupdate`、`.github/workflows/release.yml`、`scripts/update-homebrew-formula.sh`、packaging helper test | implemented |
