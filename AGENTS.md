...
The current published baseline is `v0.3.0` (2026-09-24). The CLI version authority is an immutable `vMAJOR.MINOR.PATCH` Git tag:
...
committing packaging edits, `python3 scripts/check-distribution.py --version v0.3.0`.
