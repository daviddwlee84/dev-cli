...
- `platformfs` owns the native Android Termux home anchor, inherited app-data SELinux/encryption metadata recognition and no-replace publication. Verify the exact system/app prefix and all user-controlled descendants; never trust arbitrary UID-1000 directories, relabel files, chmod Android system paths or substitute an overwriting rename.
