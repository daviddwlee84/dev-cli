...
const azureReviewJSONQuery = "[].{pullRequestId:pullRequestId,status:status,isDraft:isDraft,sourceRefName:sourceRefName,targetRefName:targetRefName,remoteUrl:remoteUrl,repositoryRemoteUrl:repository.remoteUrl}"
