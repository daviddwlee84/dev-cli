...
func TestExactLockNameWinsNormalizedCollision(t *testing.T) {
	...
	writeLock(t, filepath.Join(repository, "skills-lock.json"), 1, map[string]any{
		"Foo Bar": map[string]any{"source": "wrong/repo", "sourceType": "github", "computedHash": "one"},
		"foo-bar": map[string]any{"source": "exact/repo", "sourceType": "github", "computedHash": "two"},
	})
